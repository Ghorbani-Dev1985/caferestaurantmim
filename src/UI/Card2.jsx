...
const item = tv({
    slots: {
      base: 'flex flex-col mt-12 sm:flex-row p-6 bg-amber-200 dark:bg-stone-900 drop-shadow-xl rounded-xl',
      imageWrapper:
    ...
    <>
       <div className={base()}>
        ...
        <div className="flex-auto pl-4 sm:pl-8">
          ...
          <div className="flex gap-x-5 space-x-4">
      ...
      <section label="Select color:">
        <label htmlFor='primary'>Primary<input type='radio' value="primary" onChange={(e) => setColor(e.target.value)} name='card' id='primary'/></label>
        <br />
        <label htmlFor='secondary'>secondary<input type='radio' value="secondary" onChange={(e) => setColor(e.target.value)} name='card' id='secondary'/></label>
        <br />
        <label htmlFor='success'>success<input type='radio' value="success" onChange={(e) => setColor(e.target.value)} name='card' id='success'/></label>
      </section>
    </>
  )
}
