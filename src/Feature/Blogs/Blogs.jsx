            ...
            <React.Fragment key={id}>
              <div className="w-full flex flex-col gap-8 items-center border border-gray-200 rounded-xl p-5">
                ...
                />
                 ...
                 <Link to={`/blog/${id}`} className="flex-center gap-1 bg-primary-300 hover:bg-primary-500 text-primary-800 px-2 py-1 rounded-full transition-colors">مطالعه کنید <HiArrowNarrowLeft /></Link>
              </div>
            </React.Fragment>
          );
        })}
